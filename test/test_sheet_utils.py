...
SAMPLE_CSV_FILE_RAW_CONTENT = {CsvManager.DEFAULT_SHEET_NAME: SAMPLE_XLSX_FILE_RAW_CONTENT['Sheet2']}

SAMPLE_CSV_FILE_ITEM_CONTENT = {ItemCsvManager.DEFAULT_SHEET_NAME: SAMPLE_XLSX_FILE_ITEM_CONTENT['Sheet2']}
